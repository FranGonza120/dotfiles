...
Singleton {
    ...
    component Notif: QtObject {
        ...
        function isConnectivityNotification() {
            const text = `${appName} ${appIcon} ${summary} ${body}`.toLowerCase()
            return text.includes("bluetooth")
                || text.includes("blueman")
        ...
        function sanitizeConnectivityMedia() {
