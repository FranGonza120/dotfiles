...
![Sway](https://img.shields.io/badge/Sway-Ready-68751c?style=for-the-badge&logo=wayland&logoColor=white)

A modular desktop shell configuration built with [QuickShell](https://quickshell.org/) and QtQuick, designed for Sway on Wayland.
...
| Dependency | Purpose |
|---|---|
| `sway` | compositor IPC through `swaymsg` |
