...
Item {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                Layout.fillWidth: true
                Text { text: "Notifications"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 16; font.weight: Font.Bold; color: root.cOnSurface }
                ...
                Rectangle {
                    ...
                    Text { id: clearAllText; anchors.centerIn: parent; text: "Clear All"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 12; font.weight: Font.Medium; color: root.cOnSurfaceVariant }
            ...
            ListView {
                ...
                ColumnLayout {
                    ...
                    Text { Layout.alignment: Qt.AlignHCenter; text: "No Notifications"; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 14; font.weight: Font.Medium; color: Qt.rgba(root.cOnSurface.r, root.cOnSurface.g, root.cOnSurface.b, 0.4) }
                }
            }
        }
    }
