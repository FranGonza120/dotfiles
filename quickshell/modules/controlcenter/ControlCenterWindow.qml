            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: QsServices.Time.longDate().toUpperCase()
                            font.family: "JetBrainsMono Nerd Font"
                            font.pixelSize: 12
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: "󰌾"; font.family: "Material Design Icons"; font.pixelSize: 24; color: root.cOnSurfaceVariant }
                ...
                StyledFlickable {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            visible: mediaDockLoader.item?.hasPlayer ?? false
                            ...
                            Loader {
                                ...
                                anchors.margins: 12
                                asynchronous: true
                                source: "../bar/components/MediaPlayer.qml"

                                Binding {
                                    target: mediaDockLoader.item
                                    property: "dockMode"
                                    value: true
                                    when: mediaDockLoader.status === Loader.Ready
